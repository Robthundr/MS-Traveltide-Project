...
-- segmentation logic
CASE
WHEN total_bookings >= 10 AND avg_discount_used < 30 THEN 'High Value'
WHEN discount_sensitivity = 'High' THEN 'Deal Seeker'
WHEN total_hotel_nights >= 10 AND total_checked_bags >= 5 THEN 'Explorer'
